...
//    Endian       =  little
//    Source file  =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\lwip\lwip_v2.0.2\src\core\inet_chksum.c
//    Command line =
//        -f
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\core_1250734108783493810.dir\inet_chksum.o.rsp
//        (D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\lwip\lwip_v2.0.2\src\core\inet_chksum.c
...
//        --dependencies=n
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\core_1250734108783493810.dir\inet_chksum.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\core_1250734108783493810.dir\inet_chksum.s
//
///////////////////////////////////////////////////////////////////////////////
...
??lwip_standard_chksum_0:
        ...
        UXTH     R0,R1          
        ADD      R0,R0,R1, LSR #+16
        CBZ.N    R2,??lwip_standard_chksum_2
        LSLS     R1,R0,#+8      
        AND      R1,R1,#0xFF00  
        UBFX     R0,R0,#+8,#+8  
        ORRS     R0,R0,R1       
...
??inet_chksum_pseudo_0:
        CMP      R4,#+0         
        BNE.N    ??inet_chksum_pseudo_1
        CBZ.N    R6,??inet_chksum_pseudo_3
        BL       ?Subroutine4   
??CrossCallReturnLabel_9:
        ORRS     R7,R7,R0       
??inet_chksum_pseudo_3:
        MOV      R0,R5          
        BL       lwip_htons     
        ADDS     R4,R7,R0       
        MOV      R0,R8          
...
??CrossCallReturnLabel_0:
        ...
        UXTHNE   R0,R7          
        CMPNE    R0,#+0         
        BNE.N    ??inet_chksum_pseudo_partial_0
        BL       ?Subroutine3   
...
??Subroutine0_0:
        ...
        END
// 
// 460 bytes in section .image2.net.ram.text
// 
