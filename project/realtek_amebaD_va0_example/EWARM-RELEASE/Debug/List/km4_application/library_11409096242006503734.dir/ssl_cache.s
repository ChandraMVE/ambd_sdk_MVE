///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.60.2.399/W64 for ARM        14/Oct/2024  18:34:12
// Copyright 1999-2024 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\ssl\mbedtls-2.4.0\library\ssl_cache.c
//    Command line =
//        -f
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\library_11409096242006503734.dir\ssl_cache.o.rsp
//        (D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\ssl\mbedtls-2.4.0\library\ssl_cache.c
...
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\library_11409096242006503734.dir\ssl_cache.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\library_11409096242006503734.dir\ssl_cache.s
//
///////////////////////////////////////////////////////////////////////////////
...
??mbedtls_ssl_cache_get_0:
        ...
        STR      R0,[R5, #+96]  
        LDR      R0,[R4, #+4]   
        CBZ.N    R0,??mbedtls_ssl_cache_get_2
        ...
        BLX      R2             
        STR      R0,[R5, #+92]  
        CBZ.N    R0,??mbedtls_ssl_cache_get_1
...
??mbedtls_ssl_cache_set_1:
        ...
        ADD      R9,R9,#+1      
        BL       _memcmp        
        CBZ.N    R0,??mbedtls_ssl_cache_set_2
        MOV      R8,R4          
        LDR      R4,[R4, #+136] 
??mbedtls_ssl_cache_set_0:
        CMP      R4,#+0         
        BNE.N    ??mbedtls_ssl_cache_set_1
        LDR      R0,[R5, #+8]   
        CMP      R9,R0          
        BLT.N    ??mbedtls_ssl_cache_set_3
        LDR      R4,[R5, #+0]   
        CMP      R4,#+0         
        BEQ.N    ??mbedtls_ssl_cache_set_4
        LDR      R0,[R4, #+136] 
        MOVS     R1,#+0         
        STR      R0,[R5, #+0]   
        STR      R1,[R4, #+136] 
...
??mbedtls_ssl_cache_set_2:
        ...
        BL       _memcpy        
        LDR      R0,[R4, #+132] 
        CBZ.N    R0,??mbedtls_ssl_cache_set_6
        LDR.N    R2,??DataTable3_2
        LDR      R1,[R2, #+0]   
        BLX      R1             
        MOVS     R2,#+12        
...
??mbedtls_ssl_cache_set_6:
        LDR      R0,[R6, #+92]  
        CBZ.N    R0,??mbedtls_ssl_cache_set_7
        LDR.N    R3,??DataTable3_1
        LDR      R2,[R3, #+0]   
        LDR      R1,[R0, #+4]   
        MOVS     R0,#+1         
        BLX      R2             
        STR      R0,[R4, #+132] 
        CBZ.N    R0,??mbedtls_ssl_cache_set_4
        LDR      R1,[R6, #+92]  
        LDR      R2,[R1, #+4]   
        LDR      R1,[R1, #+8]   
        BL       _memcpy        
