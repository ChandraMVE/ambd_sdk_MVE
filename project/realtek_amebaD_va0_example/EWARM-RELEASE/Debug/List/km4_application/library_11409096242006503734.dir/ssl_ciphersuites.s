///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.60.2.399/W64 for ARM        14/Oct/2024  18:34:14
// Copyright 1999-2024 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\ssl\mbedtls-2.4.0\library\ssl_ciphersuites.c
//    Command line =
//        -f
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\library_11409096242006503734.dir\ssl_ciphersuites.o.rsp
//        (D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\common\network\ssl\mbedtls-2.4.0\library\ssl_ciphersuites.c
...
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\library_11409096242006503734.dir\ssl_ciphersuites.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\library_11409096242006503734.dir\ssl_ciphersuites.s
//
///////////////////////////////////////////////////////////////////////////////
...
ciphersuite_preference:
        DATA32
        DC32 49'196, 49'200, 159, 49'325, 49'311, 49'188, 49'192, 107, 49'162
        DC32 49'172, 57, 49'327, 49'315, 49'287, 49'291, 49'277, 49'267, 49'271
        DC32 196, 136, 49'195, 49'199, 158, 49'324, 49'310, 49'187, 49'191, 103
        DC32 49'161, 49'171, 51, 49'326, 49'314, 49'286, 49'290, 49'276, 49'266
        DC32 49'270, 190, 69, 49'160, 49'170, 22, 171, 49'319, 49'208, 179
        DC32 49'206, 145, 49'297, 49'307, 49'303, 49'323, 170, 49'318, 49'207
        DC32 178, 49'205, 144, 49'296, 49'302, 49'306, 49'322, 49'204, 143
        DC32 49'407, 157, 49'309, 61, 53, 49'202, 49'194, 49'167, 49'198
        DC32 49'190, 49'157, 49'313, 49'275, 192, 132, 49'293, 49'273, 49'289
        DC32 49'269, 156, 49'308, 60, 47, 49'201, 49'193, 49'166, 49'197
        DC32 49'189, 49'156, 49'312, 49'274, 186, 65, 49'292, 49'272, 49'288
        DC32 49'268, 10, 49'165, 49'155, 173, 183, 149, 49'299, 49'305, 172
        DC32 182, 148, 49'298, 49'304, 147, 169, 49'317, 175, 141, 49'295
        DC32 49'301, 49'321, 168, 49'316, 174, 140, 49'294, 49'300, 49'320, 139
        DC32 49'159, 49'169, 49'203, 142, 5, 4, 49'164, 49'154, 146, 138, 21, 9
        DC32 49'158, 49'168, 49'211, 49'210, 49'209, 181, 180, 45, 59, 2, 1
        DC32 49'163, 49'153, 185, 184, 46, 177, 176, 44, 0
...
mbedtls_ssl_list_ciphersuites:
        ...
        LDR.N    R4,??DataTable3
        LDR      R0,[R4, #+0]   
        CBNZ.N   R0,??mbedtls_ssl_list_ciphersuites_0
...
??mbedtls_ssl_list_ciphersuites_2:
        ...
        CBZ.N    R0,??mbedtls_ssl_list_ciphersuites_3
        LDR      R0,[R5, #+0]   
        STR      R0,[R6], #+4   
...
??mbedtls_ssl_list_ciphersuites_1:
        LDR      R0,[R5, #+0]   
        CBZ.N    R0,??mbedtls_ssl_list_ciphersuites_4
        ADD      R1,R4,#+28     
        CMP      R6,R1          
...
??mbedtls_ssl_ciphersuite_from_id_0:
        LDR      R1,[R0, #+0]   
        CBZ.N    R1,??mbedtls_ssl_ciphersuite_from_id_2
        CMP      R1,R2          
...
mbedtls_ssl_get_ciphersuite_name:
        PUSH     {R7,LR}        
        BL       mbedtls_ssl_ciphersuite_from_id
        CBNZ.N   R0,??mbedtls_ssl_get_ciphersuite_name_0
        ADR.N    R0,?_7         
        POP      {R1,PC}        
...
mbedtls_ssl_get_ciphersuite_id:
        ...
        CBZ.N    R0,??mbedtls_ssl_get_ciphersuite_id_0
        LDR      R0,[R0, #+0]   
...
// 1'061 bytes in section .rodata
//   200 bytes in section .text
// 
//   200 bytes of CODE  memory
// 1'061 bytes of CONST memory
