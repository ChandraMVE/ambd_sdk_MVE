///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.60.2.399/W64 for ARM        14/Oct/2024  18:34:31
...
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\network_14226813878260076773.dir\wsclient_tls.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\network_14226813878260076773.dir\wsclient_tls.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN mbedtls_ssl_conf_max_frag_len
        ...
        PUBLIC wss_tls_close
        PUBLIC wss_tls_connect
        PUBLIC wss_tls_handshake
        PUBLIC wss_tls_read
        PUBLIC wss_tls_write
...
??wss_tls_connect_2:
        ...
        CBZ.N    R0,??wss_tls_connect_5
        MOV      R1,R0          
        ADD      R0,R8,#+36     
??wss_tls_connect_6:
        BL       _rtl_printf    
        B.N      ??wss_tls_connect_3
??wss_tls_connect_5:
        MOVS     R1,#+0         
        MOV      R0,R6          
        ...
        MOVS     R1,#+4         
        MOV      R0,R6          
        BL       mbedtls_ssl_conf_max_frag_len
        CMP      R0,#+0         
        BPL.N    ??wss_tls_connect_7
        MOVS     R1,#+1         
        ADD      R0,R8,#+72     
        B.N      ??wss_tls_connect_6
??wss_tls_connect_7:
        MOV      R1,R6          
        MOV      R0,R4          
        BL       mbedtls_ssl_setup
        CMP      R0,#+0         
        BEQ.N    ??wss_tls_connect_4
        MOV      R1,R0          
        ADD      R0,R8,#+128    
        B.N      ??wss_tls_connect_6
??wss_tls_connect_0:
...
wss_tls_handshake:
        ...
        MOVS     R4,R0          
        BEQ.N    ??wss_tls_handshake_0
        RSBS     R4,R4,#+0      
        MOV      R1,R4          
        LDR.N    R0,??DataTable5_7
        BL       _rtl_printf    
        MOV      R4,#+4294967295
        B.N      ??wss_tls_handshake_1
??wss_tls_handshake_0:
        MOV      R0,R5          
...
wss_tls_close:
        ...
        MOV      R5,R1          
        IT       NE                
        BLNE     mbedtls_ssl_close_notify
        LDR      R0,[R5, #+0]   
        CMN      R0,#+1         
        BEQ.N    ??wss_tls_close_0
        ADD      R0,R4,#+332    
        BL       mbedtls_net_free
        MOV      R0,#+4294967295
        STR      R0,[R5, #+0]   
...
?_6:
        DATA8
        DC8 "\012[WSCLIENT] ERROR: malloc\012"
        DS8 1
...
?_7:
        DATA8
        DC8 "\012[WSCLIENT] Use ciphersuite %s\012"
...
?_0:
        DATA8
        DC8 "\012[WSCLIENT] ERROR: net_connect %d\012"
        DS8 1
        DC8 "\012[WSCLIENT] ERROR: ssl_config %d\012"
        DATA16
        DS8 2
        DATA8
        DC8 0x0A, 0x5B, 0x57, 0x53, 0x43, 0x4C, 0x49, 0x45
        DC8 0x4E, 0x54, 0x5D, 0x20, 0x45, 0x52, 0x52, 0x4F
        DC8 0x52, 0x3A, 0x20, 0x6D, 0x62, 0x65, 0x64, 0x74
        DC8 0x6C, 0x73, 0x5F, 0x73, 0x73, 0x6C, 0x5F, 0x63
        DC8 0x6F, 0x6E, 0x66, 0x5F, 0x6D, 0x61, 0x78, 0x5F
        DC8 0x66, 0x72, 0x61, 0x67, 0x5F, 0x6C, 0x65, 0x6E
        DC8 0x20, 0x25, 0x64, 0x0A, 0
        DATA
        DS8 3
        DATA8
        DC8 "\012[WSCLIENT] ERROR: ssl_setup %d\012"
        DATA
        DS8 3
...
?_4:
        DATA8
        DC8 "\012[WSCLIENT] ERROR: ssl_handshake -0x%x\012"
