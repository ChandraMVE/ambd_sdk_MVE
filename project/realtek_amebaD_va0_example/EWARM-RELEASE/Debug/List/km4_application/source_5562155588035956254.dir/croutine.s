...
//    Command line =
//        -f
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\source_5562155588035956254.dir\croutine.o.rsp
//        (D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\component\os\freertos\freertos_v10.2.0\Source\croutine.c
...
//        --dependencies=n
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\source_5562155588035956254.dir\croutine.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\source_5562155588035956254.dir\croutine.s
//
///////////////////////////////////////////////////////////////////////////////
...
vCoRoutineAddToDelayedList:
        ...
        LDRCS    R0,[R6, #+60]  
        BL       vListInsert    
        CBZ.N    R4,??vCoRoutineAddToDelayedList_0
        LDR      R0,[R6, #+68]  
        ADD      R1,R0,#+24     
        MOV      R0,R4          
        POP      {R4-R6,LR}     
...
??vCoRoutineSchedule_1:
        LDR      R1,[R4, #+84]  
        LDR      R0,[R4, #+76]  
        CBZ.N    R1,??vCoRoutineSchedule_2
        SUBS     R1,R1,#+1      
        ADDS     R0,R0,#+1      
        STR      R1,[R4, #+84]  
        CBNZ.N   R0,??vCoRoutineSchedule_3
        LDR      R2,[R4, #+64]  
        LDR      R1,[R4, #+60]  
        STR      R2,[R4, #+60]  
        STR      R1,[R4, #+64]  
??vCoRoutineSchedule_3:
        STR      R0,[R4, #+76]  
??vCoRoutineSchedule_4:
        LDR      R1,[R4, #+60]  
        LDR      R0,[R1, #+0]   
        CMP      R0,#+0         
        BEQ.N    ??vCoRoutineSchedule_1
        LDR      R0,[R1, #+12]  
        LDR      R6,[R0, #+12]  
        LDR      R0,[R4, #+76]  
        LDR      R1,[R6, #+4]   
        CMP      R0,R1          
        BCC.N    ??vCoRoutineSchedule_1
        cpsid i 
        ADDS     R0,R6,#+4      
        BL       uxListRemove   
        LDR      R0,[R6, #+40]  
        CBZ.N    R0,??vCoRoutineSchedule_5
        ADD      R0,R6,#+24     
        BL       uxListRemove   
??vCoRoutineSchedule_5:
        cpsie i 
        LDR      R0,[R6, #+44]  
        LDR      R3,[R4, #+72]  
        MOV      R1,R0          
...
??CrossCallReturnLabel_0:
        B.N      ??vCoRoutineSchedule_4
??vCoRoutineSchedule_2:
        STR      R0,[R4, #+80]  
        LDR      R0,[R4, #+72]  
        B.N      ??vCoRoutineSchedule_6
??vCoRoutineSchedule_7:
        SUBS     R0,R0,#+1      
??vCoRoutineSchedule_6:
        MUL      R1,R5,R0       
        ADDS     R3,R4,R1       
        LDR      R1,[R3, #+20]  
        CBNZ.N   R1,??vCoRoutineSchedule_8
        CMP      R0,#+0         
        BNE.N    ??vCoRoutineSchedule_7
        STR      R0,[R4, #+72]  
        POP      {R4-R6,PC}     
??vCoRoutineSchedule_8:
        LDR      R1,[R3, #+24]  
        ADD      R2,R3,#+28     
        LDR      R1,[R1, #+4]   
        STR      R1,[R3, #+24]  
...
// 494 bytes in section .image2.net.ram.text
// 
