...
//        --dependencies=n
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\Obj\km4_application\netif_6794534558298405180.dir\ethernet.o.iar_deps
//    Locale       =  C
//    List file    =
//        D:\Projects\Technosoft\BradFord\Software\CEL\CMP4020\ambd_sdk\project\realtek_amebaD_va0_example\EWARM-RELEASE\Debug\List\km4_application\netif_6794534558298405180.dir\ethernet.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC ethernet_output
        PUBLIC ethzero
        PUBLIC rarp_retrieve_hook_callback
...
ethernet_input:
        ...
        LDRB     R0,[R5, #+13]  
        ORR      R0,R0,#0x10    
        B.N      ??ethernet_input_3
??ethernet_input_2:
        MOVS     R2,#+6         
        ADR.N    R1,ethbroadcast
        MOV      R0,R3          
        BL       _memcmp        
        CBNZ.N   R0,??ethernet_input_1
        LDRB     R0,[R5, #+13]  
        ORR      R0,R0,#0x8     
??ethernet_input_3:
        STRB     R0,[R5, #+13]  
??ethernet_input_1:
        ...
        CMP      R6,#+1544      
        BEQ.N    ??ethernet_input_5
        CMP      R6,#+13696     
        BEQ.N    ??ethernet_input_6
        B.N      ??ethernet_input_0
??ethernet_input_4:
        LDRB     R0,[R4, #+55]  
        LSLS     R2,R0,#+28     
        BPL.N    ??ethernet_input_0
        LDRH     R0,[R5, #+10]  
        CMP      R0,#+13        
        BLE.N    ??ethernet_input_0
        MOV      R0,R5          
        BL       pbuf_header    
        CMP      R0,#+0         
        BNE.N    ??ethernet_input_0
        MOV      R1,R4          
        MOV      R0,R5          
        BL       ip4_input      
        B.N      ??ethernet_input_7
??ethernet_input_5:
        LDRB     R0,[R4, #+55]  
        LSLS     R2,R0,#+28     
        BPL.N    ??ethernet_input_0
...
ethernet_output:
        ...
        MOV      R0,R5          
        BL       pbuf_header    
        CBZ.N    R0,??ethernet_output_0
        MVN      R0,#+1         
        B.N      ??ethernet_output_1
??ethernet_output_0:
        LDR      R7,[R5, #+4]   
        MOVS     R2,#+6         
        MOV      R1,R9          
...
// 326 bytes in section .image2.net.ram.text
