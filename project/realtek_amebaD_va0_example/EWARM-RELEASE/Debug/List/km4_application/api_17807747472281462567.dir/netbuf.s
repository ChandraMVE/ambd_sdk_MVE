///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.60.2.399/W64 for ARM        14/Oct/2024  18:31:20
...
netbuf_alloc:
        ...
        MOVS     R4,R0          
        MOV      R5,R1          
        BEQ.N    ??netbuf_alloc_0
        LDR      R0,[R4, #+0]   
        CBZ.N    R0,??netbuf_alloc_1
        BL       pbuf_free      
??netbuf_alloc_1:
        MOVS     R2,#+0         
        MOV      R1,R5          
...
netbuf_data:
        ...
        CMPNE    R1,#+0         
        BEQ.N    ??netbuf_data_0
        CBNZ.N   R2,??netbuf_data_1
??netbuf_data_0:
        MVN      R0,#+15        
        BX       LR             
??netbuf_data_1:
        LDR      R0,[R0, #+4]   
        CBNZ.N   R0,??netbuf_data_2
        MVN      R0,#+1         
        BX       LR             
??netbuf_data_2:
        LDR      R3,[R0, #+4]   
...
??netbuf_first_0:
        ...
        END
// 
// 292 bytes in section .image2.net.ram.text
// 
